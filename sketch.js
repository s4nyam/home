...
function setup() {
   ...
   var config = {
    apiKey: "AIzaSyBsVLQk1xSbjLDtA6vYFhfcYQt2wgFBGNo",
    authDomain: "resumelocationdata.firebaseapp.com",
    databaseURL: "https://resumelocationdata.firebaseio.com",
    projectId: "resumelocationdata",
    storageBucket: "resumelocationdata.appspot.com",
    messagingSenderId: "190874723932"
  };
...
function sendToFirebase() {
  var Locations = database.ref('LatLong');
